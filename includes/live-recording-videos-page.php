                    ...
                    <tbody id="the-list">
                        ...
                        <?php
                            ...
                            <div class="notice notice-error">
                                <p>No Live Recording(s) found. You can Create Live Recording <a href="<?php echo admin_url('admin.php?page=videograph-ai-live-stream') ?>">here</a></p>
                            </div>
                        <?php
                        }
                    ?>
    ...
    <div class="wrap">
        ...
        <?php
            ...
            if ($current_page > 1) {
                ...
                $prev_url = add_query_arg(array('paged' => $prev_page, 'per_page' => $per_page), admin_url('admin.php?page=videograph-ai-live-recording-videos-page'));
                echo '<a href="' . esc_url($prev_url) . '" class="prev-page button">‹</a>';
            }
            for ($i = 1; $i <= $total_pages; $i++) {
                $page_url = add_query_arg(array('paged' => $i, 'per_page' => $per_page), admin_url('admin.php?page=videograph-ai-live-recording-videos-page'));
                $active_class = ($i === $current_page) ? 'active' : '';
                echo '<a href="' . esc_url($page_url) . '" class="' . $active_class . ' button">' . $i . '</a>';
            }
            if ($current_page < $total_pages) {
                $next_page = $current_page + 1;
                $next_url = add_query_arg(array('paged' => $next_page, 'per_page' => $per_page), admin_url('admin.php?page=videograph-ai-live-recording-videos-page'));
                ...
                <script>
                    ...
                    document.addEventListener("DOMContentLoaded", function() {
                        ...
                        form.addEventListener("submit", function(event) {
                            ...
                            const newUrl_live = "<?php echo admin_url('admin.php?page=videograph-ai-live-recording-videos-page'); ?>" +
